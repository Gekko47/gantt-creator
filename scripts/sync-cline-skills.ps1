...
.DESCRIPTION
    ...
    when the conversation matches the description. references.md is
    a resource the triggered skill loads on demand.

    This script regenerates the skills view from the canonical docs.
    It is idempotent; running it twice in a row produces the same
    output. docs/clinerules/SYNC.md explains the discipline;
