...
> Always-on rule. Regenerated by `scripts/sync-cline-skills.ps1` from `docs/01-ENVIRONMENT.md`. Do not edit it by hand; edit the canonical source and re-run the sync.
