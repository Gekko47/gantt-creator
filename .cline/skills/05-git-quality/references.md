# Full reference for 05-GIT-QUALITY.md

> Regenerated by `scripts/sync-cline-skills.ps1` from `docs/05-GIT-QUALITY.md`. Do not edit it by hand; edit the canonical source and re-run the sync.
