# Full reference for 03-ROADMAP.md

> Regenerated by `scripts/sync-cline-skills.ps1` from `docs/03-ROADMAP.md`. Do not edit it by hand; edit the canonical source and re-run the sync.
