# Full reference for 02-ARCHITECTURE.md

> Regenerated by `scripts/sync-cline-skills.ps1` from `docs/02-ARCHITECTURE.md`. Do not edit it by hand; edit the canonical source and re-run the sync.
